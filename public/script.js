var photoPosts = [{
        id: 0,
        description: "0 PhotoPost",
        createdAt: new Date('2018-02-23T23:00:00'),
        author: 'Kukel',
        photoLink: "https://i.pinimg.com/736x/ab/97/86/ab9786d84346358997f76d0953eb0e6e.jpg",
        hashTags: ["Hash", "Teg"],
        likes: ["Name1", "Name2"]
    },
    {
...
if (JSON.parse(localStorage.getItem("maxid") === null)) {

    localStorage.setItem("maxid", "20");
...
let module = (function() {
    ...
    return {
        ...
        addPhotoPost: function(photoPost) {
            maxid = Number(JSON.parse(localStorage.getItem("maxid")));
